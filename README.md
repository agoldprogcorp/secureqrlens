...
@secureqrlensbot - бот доступен и готов к использованию в Telegram!

В релиз вышло приложение на андроид - Secure Qr Lens! (Пока что не реализована AR-визуализация и используется простая ML модель, в отличии в боте).
